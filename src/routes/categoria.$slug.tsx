...
export const Route = createFileRoute("/categoria/$slug")({
  ...
  head: ({ params, loaderData }) => {
    ...
    const title = `${label} — Tem na cidade`;
    const desc = `Encontre as melhores empresas de ${name}. Endereços, contatos, avaliações e horário de funcionamento.`;
    ...
    <PageShell>
      <section className="mx-auto max-w-6xl px-4 py-10">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          {data.length} empresa(s) de {name.toLowerCase()}
        </p>
